...
# # Winner was:
# # XGBoost - 0.2 learning rate, 200 estimators, with data => dropped missings, encoded categorical
#
...
#
# train_partial, validation_partial = treat_data_dropna(train_X, validate_X)
# train_dropped_encoded, validation_dropped_encoded = treat_data_ohe(train_partial, validation_partial)
#
# train_partial, validation_partial = treat_data_dropna(train_X, test_data)
...
#
# # building model
# model = XGBRegressor(n_estimators=200, learning_rate=0.2)
...
# my_submission = pd.DataFrame({'Id': validation_data.NU_INSCRICAO, 'NU_NOTA_MT': predicted_notas})
